...
/**
 * Lee un archivo de salón y lo carga en memoria. Devuelve el salón creado o
...
/**
 * Obtiene una lista (a liberar por el usuario) con los entrenadores que cumplen
 * con la función de filtro provista. En caso de error devuelve NULL.
 */
